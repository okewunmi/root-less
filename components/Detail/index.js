        ...
        <Wrapper>
            <Content>
                <div className='txt__box'>
                    <h1 className="txt__heading">Hi, I&lsquo;m Abdul-Hafeez and my designs are Equity Focused.</h1>
                    <p className="txt__small">
                        ...
                        <div className="txt__icons">
                            <div className="icon">
                                <Image src='/ux.png' width={45} height={45} className="svg" alt="image" />
                                <p>UX Design</p>
                            </div>
                            <div className="icon">
                            <Image src='/ui.png' width={45} height={45} className="svg" alt="image" />
                                <p>UI Design</p>
                            </div>
                            <div className="icon">
                            <Image src='/search.png' width={45} height={45} className="svg" alt="image" />
                                <p>Research</p>
                            </div>
                          <div className="icon">
                          <Image src='/brand.png' width={45} height={45} className="svg" alt="image" />
                                <p>Branding</p>
                            </div>   
                        </div>
                        <div className="txt__icons">
                           <div className="icon">
                           <Image src='/product.png' width={45} height={45} className="svg" alt="image" />
                                <p>Product Strategy</p>
                            </div>
                            <div className="icon">
                            <Image src='/marketing.png' width={45} height={45} className="svg" alt="image" />
                                <p>Marketing</p>
                            </div>
                            <div className="icon">
                            <Image src='/marketing.png' width={45} height={45} className="svg" alt="image" />
                ...
                <div className='image__box'>
                    <Image src='/laptophone.png' width={400} height={400}  className="img" alt="image"/>
                </div>
            </Content>
            <Service>
